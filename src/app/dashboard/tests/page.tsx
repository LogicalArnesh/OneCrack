...
import { ClipboardList, Clock, Info, Play, Calendar } from 'lucide-react';
...
export default function TestsListPage() {
  ...
  useEffect(() => {
    ...
    // Filter by class level in real scenario
    setTests(allTests.filter(t => t.classLevel === user?.classLevel || t.classLevel === 'Dropper'));
  }, [user]);
      ...
      <div className="space-y-8">
        <div className="flex items-center justify-between">
          <div className="space-y-1">
            ...
            <p className="text-muted-foreground">Evaluations tailored for Class {user?.classLevel}</p>
          </div>
        </div>
